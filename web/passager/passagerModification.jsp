        ...
        <div class="ui padded grid">
            <div class="row">
                <h1 class="ui huge dividing header">
                    ${passager.prenomPassager}, ${passager.nomPassager}
                </h1>
            </div>
            <div class="row">
                <form class="ui form" method="post">
                    <div class="field">
                        ...
                        <input type ="text" value="${passager.numeroCNI}" name="numeroCNI">
                    </div>
                    <div class="field">
                        <label>Nom de famille : </label>
                        <input type ="text" value="${passager.nomPassager}" name="nomPassager">
                    </div>
                    <div class="field">
                        <label>Prénom : </label>
                        <input type ="text" value="${passager.prenomPassager}" name="prenomPassager">
                    </div>
                    <div class="field">
                        <label>E-mail : </label>
                        <input type ="text" value="${passager.emailPassager}" name="emailPassager">
                    </div>
                    <div class="field">
                        <label>Genre : </label>
                        <input type="text" value="${passager.genrePassager}" name="genrePassager">
                    </div>
                    <div class="field">
                        <label>Date de naissance : </label>
                        <input type ="date" value="${passager.dateNaissancePassager}" name="dateNaissancePassager">
                    </div>
                    <div class="field">
                        <label>Numéro de téléphone : </label>
                        <input type ="text" value="${passager.numeroTelephonePassager}" name="numeroTelephonePassager">
                    </div>
                    <div class="field">
                        <label>Mot de passe : </label>
                        <input type ="password" value="${passager.motDePassePassager}" name="motDePassePassager">
                    </div>
            ...
            <div class="row">
                ...
                <a href="<%=request.getContextPath()+"/passager/delete?id="%>${passager.numeroCNI}">
                    <div class="ui animated fade red basic button" tabindex="0">
                        <div class="visible content">Supprimer ce passager</div>
                        <div class="hidden content">
