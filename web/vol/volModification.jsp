...
<%--Contenu de la page--%>
    <div class="sixteen wide mobile thirteen wide tablet thirteen wide computer right floated column" id="content">
        <div class="ui padded grid">
            <div class="row">
                <h1 class="ui huge dividing header">Vol de ${vol.villeDepartVol} à destination de ${vol.villeArriveeVol} </h1>
            </div>
            <div class="row">
                <form class="ui form" method="post">
                    <div class="two fields">
                        <div class="field">
                            ...
                            <input type="text" value="${vol.villeDepartVol}" name="villeDepart">
                        </div>
                        <div class="field">
                            <label>Ville d'arrivée</label>
                            <input type="text" value="${vol.villeArriveeVol}" name="villeArrive">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <a href="<%=request.getContextPath()+"/vol/delete?id="%>${vol.idVol}">
                    <div class="ui animated fade red basic button" tabindex="0">
                        <div class="visible content">Supprimer ce vol</div>
                        <div class="hidden content">
