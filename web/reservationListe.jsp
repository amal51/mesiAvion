                ...
                <table class="ui single line striped selectable unstackable table">
                    ...
                    <c:forEach items="${listeReservation}" var="reservation" varStatus="status">
                        <tr>
                            ...
                            <td>${reservation.idDetailsVols.ARN.modeleAvion.nomAvion}</td>
                            <td>${reservation.idDetailsVols.ARN.ARN}</td>
                            <td>
                                <a href="/reservation/edition?id=${reservation.idReservation}" ><i class="edit icon"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
